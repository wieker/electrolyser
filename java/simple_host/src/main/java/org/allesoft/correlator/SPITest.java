...
public class SPITest
{
    ...
    public static void main(String[] args) throws Exception {
        ...
        spi_select(handle);
        sendCommand(handle, 4, new byte[] { (byte) 0x1E }, true);
        Thread.sleep(100);
        spi_desel(handle);

        spi_select(handle);
        sendCommand(handle, 4, new byte[] { (byte) 0x40 }, true);
        Thread.sleep(100);
        spi_desel(handle);

        spi_select(handle);
        sendCommand(handle, 4, new byte[] { (byte) 0x00, 0x00, 0x00, 0x00 }, true);
        Thread.sleep(100);
        spi_desel(handle);

        spi_select(handle);
        sendCommand(handle, 4, new byte[] { (byte) 0xA0, 0x00, 0x00, 0x00 }, true);
        Thread.sleep(100);
        spi_desel(handle);

        spi_select(handle);
        sendCommand(handle, 4, new byte[] { (byte) 0xA2, 0x00, 0x00, 0x00 }, true);
        Thread.sleep(100);
        spi_desel(handle);

        spi_select(handle);
        sendCommand(handle, 4, new byte[] { (byte) 0xAE, 0x00, 0x00, 0x00 }, true);
        Thread.sleep(100);
        spi_desel(handle);

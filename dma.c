...
void DMAC_Initialize( void )
{
    ...
    DMAC->CHCTRLB.reg = DMAC_CHCTRLB_TRIGACT(0) | DMAC_CHCTRLB_TRIGSRC(0) | DMAC_CHCTRLB_LVL(0) ;

    descriptor_section[0].DMAC_BTCTRL = DMAC_BTCTRL_BLOCKACT_INT | DMAC_BTCTRL_BEATSIZE_WORD | DMAC_BTCTRL_VALID | DMAC_BTCTRL_DSTINC ;
